	...
	<div class="row">
		...
		<table class="table">
			<tr>
				...
				<td width="85%">
					<input type="text" name="name" class="input-sm" value="<%=vo.getName()%>">
			...
			<tr>
				...
				<td width="85%">
					<textarea row="10" col="50" name="content" class="input-sm"><%=vo.getContent() %></textarea>
				</td>
			</tr>
			<tr>
			...
			<tr><td colspan="2">
				<button class="btn btn-sm btn-danger" onclick="board_write()" value="수정"></button>
