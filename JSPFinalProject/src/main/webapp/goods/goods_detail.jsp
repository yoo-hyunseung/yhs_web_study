    ...
    <%--
    	...
    	서버
    	 => Front-Controller
    	  ...
    	  => JSP 에서는 request에 들어가 있는 데이터를 출력하기 쉽게
    	     ${} (EL), JSTL-> 자바에서 제공하는 제어문 , 메소드... 태그형으로 제공
  			...
  			<table class="table">
  				<tr>
  					<td width="40%" class="text-center" rowspan="7">
  						<img alt="" src="${vo.goods_poster }" style="width: 100%">
  					</td>
  				...
  				<tr>
  					<td><span style="color: green; font-size: 8pt;">첫구매 할인가</span>&nbsp;
  					<span style="color: green;">${vo.goods_first_price }</span></td>
  				</tr>
  				<tr>
  				...
  				<tr>
  					<td>
  						수량:<select name="account" class="input-sm" style="width: 350xp">
